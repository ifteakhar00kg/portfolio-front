...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ifteakar | Full Stack Developer — Spring Boot & React · Dhaka" },
      {
        name: "description",
        content:
          "Ifteakar — full stack developer in Dhaka. Spring Boot, React, and custom API & AI integrations.",
      },
      { name: "author", content: "Ifteakar" },
      { property: "og:site_name", content: "Ifteakar" },
